...
| ------------- | ---------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Cloudflare    | DNS records      | fedi.yutakobayashi.com (A), git.yutakobayashi.com (CNAME), niks3.yutakobayashi.com (CNAME), nostr.yutakobayashi.com (CNAME), SES DKIM (CNAME x3), SES MAIL FROM (MX + TXT), Resend DKIM (TXT), Bluesky DID (TXT) |
